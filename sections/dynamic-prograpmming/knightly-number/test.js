// knightly number
// A knight is on a chess board. Can you figure out the total number of ways the knight
// can move to a target position in exactly m moves? On a single move, the knight can
// move in an "L" shape; two spaces in any direction, then one space in a perpendicular
// direction. This means that on a single move, a knight has eight possible positions
// it can move to.
